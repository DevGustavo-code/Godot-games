...
var velocidade_max = 400  # Velocidade máxima de movimento
var forca_pulo = -600  # Força do pulo
...
var vida = 5  # Vida inicial do jogador
...
func _redefinir_posicao():
	# Reseta a posição do jogado5r para um ponto de início, por exemplo
	global_position = Vector2(65, 65)  # Defina a posição inicial conforme necessário
